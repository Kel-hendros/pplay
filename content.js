...
const CONTENT = {
  meta: {
    ...
    series: "Power Plays · Game Theory & Drama Theory",
  },
  ...
  rol: {
    title: "Tu rol",
    paragraphs: [
      "Sos el CEO interino de Aethelgard, una empresa de tecnología de energía limpia.",
      "Llevás más de 5 años en la empresa. Conocés a la gente, entendés el negocio, y sabés cómo se mueven las cosas por adentro. Cuando la CEO anterior se fue por diferencias con el Board, te ofrecieron el puesto de transición. Aceptaste — no solo por responsabilidad, sino porque sabés que si demostrás que tenés las Power Skills necesarias, el puesto puede ser tuyo.",
    ...
    tips: [
      ["Escuchá antes de hablar.", "Cada persona que encuentres tiene su propia agenda. Entender qué quieren te da ventaja."],
      ["Lo que decís importa.", "En las conversaciones, podés escribir lo que quieras. Cómo lo digas va a cambiar cómo te respondan."],
      ["Todo conecta.", "Lo que hagas en una conversación puede abrir o cerrar puertas en la siguiente."],
      ["No intentes tener razón — intentá ser efectivo.", "A veces la mejor jugada no es la más obvia."],
      ["Pensá y actuá estratégicamente.", "No dejes que tu ego tome tus decisiones."],
    ],
  },
  ...
  rachelMessage: {
    ...
    body: [
      ...
      "Tenés 48 horas antes de que la Junta vote si acepta o rechaza la oferta.",
      "Te armé un dossier. Adentro está todo: quiénes son los actores, qué quiere cada uno, dónde estamos parados.",
      "No suavizo: esto es lo más difícil que te va a tocar. Pero por algo te pusieron acá.",
      "— Rachel",
    ],
  },
  ...
  dossier: {
    situacion: [
      ...
      "Hace unas semanas el Board te nombró CEO interino tras la salida abrupta de la CEO anterior. Conocés Aethelgard por dentro, pero liderar es otra cosa.",
    ...
    favor: [
      ...
      "El mercado de energía limpia está en auge — hay otros compradores potenciales si querés contraoferta.",
    ],
    contra: [
      ...
      "Harrison tiene miedo. Si no lo convencés, vota sí.",
      "Sos nuevo en el rol. Todavía tenés que demostrar que podés liderar bajo presión.",
    ],
  },
  ...
  transition1c: {
    ...
    narrator: "Tu bandeja explota. Tres periodistas pidiendo declaraciones. Un analista de Goldman publicó una nota diciendo que la oferta de Titan “refleja el riesgo real del pipeline tecnológico de Aethelgard”. Y en el grupo de WhatsApp del equipo ejecutivo, nadie dice nada — todos esperan que hables vos primero.\n\nEs tu primera crisis como CEO. Y el reloj ya está corriendo.",
  },
    ...
    options: [
      {
        ...
        rachel: "Es agresivo pero claro. Si los números son sólidos, la prensa nos da bola. El riesgo: una vez que peleamos en público, la historia se vuelve un espectáculo — y eso presiona a todos, incluyendo al Board.",
      },
      {
  ...
  briefs: {
    sia: {
      ...
      lines: [
        ...
        "Si le hablás de “sinergias” o “alinear stakeholders” te corta el teléfono.",
      ],
    },
    harrison: {
      ...
      lines: [
        ...
        "Es el voto decisivo: si Harrison vota no, el Board lo acompaña. Si Sia se va, él no tiene motivo para bancar esto.",
        "Hablale desde la confianza, no desde los números — los números se los puede sacar un analista. Y sé honesto sobre lo que pasó con Sia: él ya tiene su propia lectura y va a notar si maquillás.",
      ],
    },
  },
};
