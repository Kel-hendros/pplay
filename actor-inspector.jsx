...
const __AOI_STYLE = `
  ...
  .aoi-gate .warn{font-size:11.5px;color:var(--ink-3)}
  .aoi-input{height:38px;padding:0 12px;border:1px solid var(--line);border-radius:9px;
    background:var(--surface);color:var(--ink);font:inherit;font-size:14px;outline:none}
  .aoi-input:focus{border-color:var(--ink-4)}
  .aoi-input.err{border-color:var(--danger)}
  .aoi-go{height:38px;border:0;border-radius:9px;background:var(--accent);
    color:var(--accent-ink);font:inherit;font-weight:600;font-size:13px;cursor:pointer}
  .aoi-err{font-size:12px;color:var(--danger)}

  .aoi-card{border:1px solid var(--line);border-radius:12px;background:var(--surface);overflow:hidden}
  ...
  .aoi-card-rl{font-size:11.5px;color:var(--ink-3);margin-top:1px}
  ...
  .aoi-field-val{font-size:13px;line-height:1.5;color:var(--ink-2)}
  .aoi-list{margin:0;padding-left:16px;display:flex;flex-direction:column;gap:4px}
  .aoi-list li{font-size:13px;line-height:1.45;color:var(--ink-2)}
  ...
  .aoi-note{font-size:11.5px;color:var(--ink-3);font-style:italic;line-height:1.45}

  .aoi-details{border:1px solid var(--line);border-radius:9px;background:var(--bg)}
  ...
  .aoi-details>summary:hover{color:var(--ink)}
  .aoi-copy{font-family:var(--mono);font-size:10px;border:1px solid var(--line);
